...
• уникальную карточку игрока — на выбор доступен  вариант, представлены ниже;

•бесконечный доступ к проекту.

Советуем приобрести проходку сейчас: по мере развития проекта её стоимость будет постепенно увеличиваться.

Вопросы? - @AstraOrigins1"""
...
Если вы уверены, что оплатили - отправьте чек ещё раз или свяжитесь с @AstraOrigins1"""
